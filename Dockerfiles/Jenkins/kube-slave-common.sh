...
NODEJS_SLAVE=${NODEJS_SLAVE_IMAGE:-docker-registry-default.nocp.vs.csint.cz/openshift3/jenkins-slave-nodejs-rhel7}
MAVEN_SLAVE=${MAVEN_SLAVE_IMAGE:-docker-registry-default.nocp.vs.csint.cz/openshift3/jenkins-slave-maven-rhel7}
